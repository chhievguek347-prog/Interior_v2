...
{
    public class LivingFurnitureInspector : MonoBehaviour
    {
        ...
        private void Start()
        {
            if (targetFocus == null)
            {
                GameObject centerObj = GameObject.Find("Sofa3Seater_Detailed");
        ...
        private void LateUpdate()
        {
            ...
            distance = Mathf.Clamp(distance, 1.5f, 12.0f);
