...
namespace Interior.ScandiVR
{
    ...
    public class ScandiVRPlayerSetup : MonoBehaviour
    {
        [Header("VR / FPS Settings")]
        public float moveSpeed = 2.8f;
        public float mouseSensitivity = 2.0f;
        public float playerEyeHeight = 1.65f;
        ...
        private void Start()
        {
            ...
            if (m_PlayerCam == null && Camera.main != null)
            {
                ...
                m_PlayerCam.transform.localPosition = new Vector3(0, playerEyeHeight, 0);
            }
        ...
        private void Update()
        {
            ...
            m_CC.Move(move * moveSpeed * Time.deltaTime + Vector3.down * 9.81f * Time.deltaTime);
        }
