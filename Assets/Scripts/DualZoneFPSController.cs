...
namespace Interior.DualZone
{
    ...
    public class DualZoneFPSController : MonoBehaviour
    {
        [Header("Movement & Look Parameters")]
        ...
        private void Update()
        {
            ...
            m_CC.Move(move * currentSpeed * Time.deltaTime + Vector3.down * 9.81f * Time.deltaTime);
        }
